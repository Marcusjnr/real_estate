...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    locationFadeController = AnimationController(
    ...
    staggeredSlowAnimationController = AnimationController(
        duration: const Duration(seconds: 2),
        vsync: this
    );

    staggeredFastAnimationController = AnimationController(
        duration: const Duration(seconds: 1),
        vsync: this
    );

    selectPerfectPlaceStaggeredAnimationController = AnimationController(
        duration: const Duration(seconds: 1),
        vsync: this
    );
                   ...
                   height: getDeviceHeight(context) * .6,
                    ...
                    decoration:  BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [AppColors.primary.withOpacity(.4), AppColors.primary.withOpacity(.02)],
                            ...
                            SizeTransition(
                              ...
                              child: Container(
                                ...
                                child: FadeTransition(
                                  ...
                                  child: const Row(
                                    children: [
                                      Icon(Icons.location_on_rounded, color: AppColors.appBrown,),
                                      Text(
                                        'Saint Petersburg',
                                        style: TextStyle(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: const DecorationImage(
                          image: AssetImage('assets/images/house_pic_living.jpg'),
                          fit: BoxFit.cover,
                        )
                      ),
                    ),
  ...
  void dispose() {
    ...
    locationFadeController.removeStatusListener((_) { });
    greetingAnimationController.removeStatusListener((_) { });
  }
}
